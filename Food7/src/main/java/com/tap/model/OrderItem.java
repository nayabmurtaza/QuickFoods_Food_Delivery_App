...
public class OrderItem {
    ...
    // Parameterized constructor (omitting orderItemId since MySQL handles it via Auto-Increment)
    ...
    // Full parameterized constructor (useful when pulling item history out of the database)
    ...
    public void setItemTotal(double totalPrice) {
